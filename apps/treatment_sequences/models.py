...
class Sequence:
    ...
    def add_sequence_from_patient(self, date, shift, doctor, patient, status=1):
        ...
        code = count + 1
        if shift == "AM":
            shift_formatted = "Manhã"
        if shift == "PM":
            shift_formatted = 'Tarde'
    ...
    def process_sequence(self, code, diagnostic_code, treatment_code, treatment_price, treatment_quantity):
        ...
        try:
            ...
            return "Oops, prontuário não processado"
        return True
    ...
    def delete_sequence_treatment(self, code, code2, subtotal):
        ...
        if sequence is None:
            return "Prontuário não encontrado"
        new_total = sequence['total'] - float(subtotal.replace(',','.'))
        try:
            ...
            if result:
                ...
                try:
                    ...
                    return "Oops, Tratamento deletado, mas prontuário não atualizado"
        except errors.OperationFailure:
            return "Oops, Tratamento não deletado"
        return True
    ...
    def close_sequence(self, code):
        ...
        try:
            ...
            return "Oops, prontuário não concluído"
        return True
